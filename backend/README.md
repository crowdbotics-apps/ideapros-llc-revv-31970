...
## Project Structure
    ...
    ├── ideapros_llc_revv_31970  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_revv_31970`
...
2. Clone this repo and `cd ideapros_llc_revv_31970`
